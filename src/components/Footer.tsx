        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link href="/roster" className="text-neutral-500 hover:text-white text-sm transition-colors">Roster</Link>
              <Link href="/contact" className="text-neutral-500 hover:text-white text-sm transition-colors">Contact</Link>
            </nav>
          </div>

          <div>
            <h4 className="text-white font-medium mb-4 uppercase tracking-wider text-sm">Follow Us</h4>
